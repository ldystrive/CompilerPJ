...
{
  "$end", "error", "$undefined", "INTEGER", "REAL", "ADD", "SUB", "MUL",
  "DIV", "LPAREN", "RPAREN", "EOL", "$accept", "calc", "exp", "factor",
  "term", "number", YY_NULLPTR
};
#endif
...
{
       2,    11,    12,     3,     4,     3,     4,    13,    16,     5,
       0,     5,     3,     4,    14,    15,    17,    18,    19,    20,
      10
};

static const yytype_int8 yycheck[] =
{
       0,     5,     6,     3,     4,     3,     4,    11,    10,     9,
      -1,     9,     3,     4,     7,     8,    11,    12,    14,    15,
       5
};
